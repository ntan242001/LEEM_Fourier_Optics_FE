...
startTimeStamp = datetime.now().strftime('%d%m%Y_%H%M%S')
...
reversed_obj = obj[::-1] # the object is reversed in the lens, this line is to reversed the object for simplier calculation.
