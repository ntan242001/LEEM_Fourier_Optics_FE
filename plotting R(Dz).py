...
# plt.plot(delta_z_series1/(C_5*lamda**2)**(1/3), resolution_list1, label = 'Gaussian')
...
# plt.vlines(x=1, ymin=0, ymax=8)

plt.title('Resolution versus defocus for standard LEEM, $\pi$ phase')
